...
async function cargarProyecto(){
    ...
    const respuesta = await fetch("http://localhost:808/api/proyecto");

    const datos = await respuesta.json();

    const proyecto = datos[0];

    document.getElementById("nombre").innerHTML = proyecto.nombre;

    document.getElementById("descripcion").innerHTML = proyecto.descripcion;

    document.getElementById("objetivos").innerHTML = proyecto.objetivos;
